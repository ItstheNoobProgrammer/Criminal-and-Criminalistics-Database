...
int flag;
        ...
        // TODO add your handling code here:
         try
         {
            ...
            if(rs.next())
            {
                ...
                String imageURL = System.getProperty("user.dir")+"/Victim_Images" + "/" + rs.getString("v_id") + ".jpg";
                label.setIcon(resizeImage(imageURL));
                
                String imageURL2 = System.getProperty("user.dir")+"/Victim_FingerImages" + "/" + rs.getString("v_id") + ".jpg";
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        try
        {
    		...
    		File file = new File(System.getProperty("user.dir")+"/Victim_Images" + "/" + rs.getString("vid") + ".jpg");
                File file2 = new File(System.getProperty("user.dir")+"/Victim_FingerImages" + "/" + rs.getString("vid") + ".jpg");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try
        {
            ...
            try{
                ...
                String location = System.getProperty("user.dir")+"/Victim_Images/" + vid.getText() + ".jpg";
                String locationfp = System.getProperty("user.dir")+"/Victim_FingerImages/" + vid.getText() + ".jpg";
                String format = "jpg";
