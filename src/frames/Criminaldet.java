...
public class Criminaldet extends javax.swing.JFrame {
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
            ...
            if(rs.next())
            {
               ...
               String imageURL = System.getProperty("user.dir")+"/Criminal_Images" + "/" + rs.getString("criminal_id") + ".jpg";
               String imagefpURL = System.getProperty("user.dir")+"/FingerPrint_Images" + "/" + rs.getString("criminal_id") + ".jpg";
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        try
        {
    		...
    		File file = new File(System.getProperty("user.dir") + "/" + rs.getString("criminal_id") + ".jpg");
        	File filefp = new File(System.getProperty("user.dir")+"/FingerPrint_Images" + "/" + rs.getString("criminal_id") + ".jpg");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try
        {
            ...
            String locationfp = System.getProperty("user.dir")+"/FingerPrint_Images/" + criminalid.getText() + ".jpg";
            String location = System.getProperty("user.dir")+"/Criminal_Images/" + criminalid.getText() + ".jpg";
            String format = "jpg";
            String formatfp = "jpg";
